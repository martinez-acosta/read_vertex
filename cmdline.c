...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->bezier_arg = NULL;
  args_info->bezier_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->rotate_help = gengetopt_args_info_help[4] ;
  args_info->scale_help = gengetopt_args_info_help[5] ;
  args_info->resolution_help = gengetopt_args_info_help[6] ;
  args_info->wireframe_help = gengetopt_args_info_help[7] ;
  args_info->bezier_help = gengetopt_args_info_help[8] ;
  args_info->faceHiding_help = gengetopt_args_info_help[9] ;
  args_info->flatShading_help = gengetopt_args_info_help[10] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->bezier_arg));
  free_string_field (&(args_info->bezier_orig));
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVi:d:rs:b:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 's':	/* Escalar la figura: s0,s1.  */
          ...
          break;
        case 'b':	/* curva de bézier a seguir en la forma p1,p2,p3,p4.  */
        
        
          if (update_arg( (void *)&(args_info->bezier_arg), 
               &(args_info->bezier_orig), &(args_info->bezier_given),
              &(local_args_info.bezier_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "bezier", 'b',
              additional_error))
            goto failure;
